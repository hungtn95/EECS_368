...
;;; Definition of true and false when running under a Standard Scheme
(define true #t)
(define false #f)
;;;
...
;;;
(define (error s v) (newline) (write s) (write v))
;;;
...
;;;-----------------------------------------
;;; To make the Logic Programming system start up with the Microshaft knowledgebase when you hit the RUN button
(initialize-data-base microshaft-data-base)
(query-driver-loop)
;;;-----------------------------------------
